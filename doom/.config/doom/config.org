...
After setting the variable delete the lsp-session file in =~/.config/emacs/.local/cache= (or delete the entire directory which will have other repercussions like needed to readd projects to projectile)
