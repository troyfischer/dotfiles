...
(use-package! lsp-lua
  :config
  (setq lsp-clients-lua-language-server-bin "/Users/troyfischer/.local/share/nvim/mason/bin/lua-language-server"
        lsp-clients-lua-language-server-main-location "/Users/troyfischer/.local/share/nvim/mason/packages/lua-language-server/libexec/main.lua")
  (setq lsp-lua-workspace-library (ht
                                   ("/Users/troyfischer/.local/share/nvim/site/pack/deps/opt" t)
                                   ("/opt/homebrew/Cellar/neovim/0.10.2_1/share/nvim/runtime" t))))
#+end_src
** Java
#+begin_src emacs-lisp :tangle no
