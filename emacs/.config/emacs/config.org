...
(when IS-MAC (set-face-attribute 'default nil :font "JetBrainsMono Nerd Font" :height 150))
...
#+end_src
** Yes or No
Don't force me to type out yes or no.
#+begin_src emacs-lisp
...
(my-leader-def
  ...
  "w S"   '(+evil/window-split-and-follow :which-key "Horizontal split window")
  "w v"   '(evil-window-vsplit :which-key "Vertical split window")
  "w V"   '(+evil/window-vsplit-and-follow :which-key "Vertical split window")
  ;; Window motions
  "w h"   '(evil-window-left :which-key "Window left")
  "w H"   '(+evil/window-move-left :which-key "Window left")
  "w j"   '(evil-window-down :which-key "Window down")
  "w J"   '(+evil-window-move-down :which-key "Window down")
  "w k"   '(evil-window-up :which-key "Window up")
  "w K"   '(+evil/window-move-up :which-key "Window up")
  "w l"   '(evil-window-right :which-key "Window right")
  "w L"   '(+evil/window-move-right :which-key "Window right")
...
(use-package projectile
  ...
  (my-leader-def
    ...
    "p g" '(projectile-ripgrep :which-key "Ripgrep")))
...
(use-package lsp-pyright
  ...
  :hook (python-mode . (lambda ()
                          (require 'lsp-pyright)
                          (lsp-deferred)))
         (python-mode . (lambda () (lsp-pyright-locate-venv)))
  :config
    (setq lsp-pyright-venv-directory "~/.local/share/virtualenvs"))
#+end_src
*** Add Pip installed packages to path
#+begin_src emacs-lisp
(add-to-list 'exec-path "/Users/troy/Library/Python/3.10/bin")
#+end_src
*** Pipenv
#+begin_src emacs-lisp
(use-package pipenv
  ...
  :config
  (general-nmap
    :prefix (concat my-local-leader " e")
